...
# 3. Tasks
collect_task = Task(
    description="Perform an internet search using the query: 'AI Master degree from top university or Ivy league in USA. The should be online or Hybrid'. Return results with entire degree fee.",
    expected_output="List of university name and cost of master in AI.",
    agent=data_agent,
    name="collect_data",
    is_start=True,
